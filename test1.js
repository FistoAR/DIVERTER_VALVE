...
window.scrollTo(0, 0);
// change the following page numbers in case if additional pages were added or existing removed: line - 18, 420, 670
...
const slides = [
  {
    id: "secondSlidenew",
    flag: "hasShownSecondSlidenew",
    done: "secondSlidenewAnimationCompleted",
    line: "#secondSlidenew .vertical-line",
  },
  {
    id: "secondSlide",
    flag: "hasShownSecondSlide",
    done: "secondSlideAnimationCompleted",
    line: "#secondSlide .vertical-line",
  },
  {
    id: "fourthSlide",
    flag: "hasShownFourthSlide",
    done: "fourthSlideAnimationCompleted",
    line: "#fourthSlide .fourth-vertical-line",
  },
  { id: "dtdHome", flag: "hasShownDtdHome", done: "dtdHomeAnimationCompleted" },
  {
    id: "fifthnewSlide",
    flag: "hasShownFifthnewSlide",
    done: "fifthnewSlideAnimationCompleted",
    line: "#fifthnewSlide .vertical-line",
  },
  {
    id: "detailsSlide",
    flag: "hasShownDetailsSlide",
    done: "detailsSlideAnimationCompleted",
    line: "#detailsSlide .details-vertical-line",
  },
  {
    id: "new-detailsSlide",
    flag: "hasShownNew-detailsSlide",
    done: "new-detailsSlideAnimationCompleted",
    line: "#new-detailsSlide .details-vertical-line",
  },
  {
    id: "twelevenewSlide",
    flag: "hasShownTweleveNewSlide",
    done: "twelevenewSlideAnimationCompleted",
  },
  {
    id: "thirteenSlide",
    flag: "hasShownThirteenSlide",
    done: "thirteenSlideAnimationCompleted",
    line: "#thirteenSlide .thirteen-vertical-line",
  },
  { id: "bvdHome", flag: "hasShownBvdHome", done: "bvdHomeAnimationCompleted" },
  {
    id: "nineSlide",
    flag: "hasShownNineSlide",
    done: "nineSlideAnimationCompleted",
    line: "#nineSlide .nine-vertical-line",
  },
  {
    id: "detailsSlidenew9",
    flag: "hasShownDetailsSlidenew9",
    done: "detailsSlidenew9AnimationCompleted",
    line: "#detailsSlidenew9 .details-vertical-line",
  },
  {
    id: "detailsSlidenew1",
    flag: "hasShownDetailsSlidenew1",
    done: "detailsSlidenew1AnimationCompleted",
  },
  {
    id: "BDVModel",
    flag: "hasShownDetailsBDVModel",
    done: "BDVModelAnimationCompleted",
  },
  {
    id: "fifteenSlide",
    flag: "hasShownFifteenSlide",
    done: "fifteenSlideAnimationCompleted",
    line: "#fifteenSlide .fifteen-vertical-line",
  },
  {
    id: "sdtdHome",
    flag: "hasShownSdtdHome",
    done: "sdtdHomeAnimationCompleted",
  },
  {
    id: "sixSlide",
    flag: "hasShownSixSlide",
    done: "sixSlideAnimationCompleted",
    line: "#sixSlide .six-vertical-line",
  },
  {
    id: "detailsSlidenew",
    flag: "hasShownDetailsSlidenew",
    done: "detailsSlidenewAnimationCompleted",
    line: "#detailsSlidenew .details-vertical-line",
  },
  {
    id: "detailsSlidenew2",
    flag: "hasShownDetailsSlidenew2",
    done: "detailsSlidenew2AnimationCompleted",
  },
  {
    id: "SDTDModel",
    flag: "hasShownDetailsSDTDModel",
    done: "SDTDModelAnimationCompleted",
  },
  {
    id: "fourteenSlide",
    flag: "hasShownFourteenSlide",
    done: "fourteenSlideAnimationCompleted",
    line: "#fourteenSlide .fourteen-vertical-line",
  },
  {
    id: "sdtdcHome",
    flag: "hasShownSdtdcHome",
    done: "sdtdcHomeAnimationCompleted",
  },
  {
    id: "new-sixSlide",
    flag: "hasShownNew-sixSlide",
    done: "new-sixSlideAnimationCompleted",
    line: "#new-sixSlide .six-vertical-line",
  },
  {
    id: "detailsSlidenew3",
    flag: "hasShownDetailsSlidenew3",
    done: "detailsSlidenew3AnimationCompleted",
    line: "#detailsSlidenew3 .details-vertical-line",
  },
  {
    id: "detailsSlidenew4",
    flag: "hasShownDetailsSlidenew4",
    done: "detailsSlidenew4AnimationCompleted",
  },
  {
    id: "SDTDCModel",
    flag: "hasShownDetailsSDTDCModel",
    done: "SDTDCModelAnimationCompleted",
  },
  {
    id: "fourteenSlide-new",
    flag: "hasShownFourteenSlide-new",
    done: "fourteenSlide-newAnimationCompleted",
    line: "#fourteenSlide-new .fourteen-vertical-line",
  },
  {
    id: "ytypeHome",
    flag: "hasShownYtypeHome",
    done: "ytypeHomeAnimationCompleted",
  },
  {
    id: "eightSlide",
    flag: "hasShownEightSlide",
    done: "eightSlideAnimationCompleted",
    line: "#eightSlide .eight-vertical-line",
  },
  {
    id: "detailsSlidenew5",
    flag: "hasShownDetailsSlidenew5",
    done: "detailsSlidenew5AnimationCompleted",
    line: "#detailsSlidenew5 .details-vertical-line",
  },
  ...
  {
    id: "fourteenSlide-new1",
    flag: "hasShownFourteenSlide-new1",
    done: "fourteenSlide-new1AnimationCompleted",
    line: "#fourteenSlide-new1 .fourteen-vertical-line",
  },
  {
    id: "scaleHome",
    flag: "hasShownScaleHome",
    done: "scaleHomeAnimationCompleted",
  },
  {
    id: "sixteenthSlide",
    flag: "hasShownSixteenthSlide",
    done: "sixteenthSlideAnimationCompleted",
    line: "#sixteenthSlide .sixteenth-vertical-line",
  },
  {
    id: "seventeenthSlide",
    flag: "hasShownSeventeenthSlide",
    done: "seventeenthSlideAnimationCompleted",
    line: "#seventeenthSlide .seventeenth-vertical-line",
  },
  {
    id: "seventeenthSlide-new",
    flag: "hasShownSeventeenthSlide-new",
    done: "seventeenthSlide-newAnimationCompleted",
  },
  // { id: 'SCALEModel', flag: 'hasShownDetailsSCALEModel', done: 'SCALEModelAnimationCompleted' },
  {
    id: "fourteenSlide-new2",
    flag: "hasShownFourteenSlide-new2",
    done: "fourteenSlide-new2AnimationCompleted",
    line: "#fourteenSlide-new2 .fourteen-vertical-line",
  },
  ...
  {
    id: "fourteenSlide-new3",
    flag: "hasShownFourteenSlide-new3",
    done: "fourteenSlide-new3AnimationCompleted",
    line: "#fourteenSlide-new3 .fourteen-vertical-line",
  },
  {
    id: "bypassHome",
    flag: "hasShownBypassHome",
    done: "bypassHomeAnimationCompleted",
  },
  {
    id: "nineteenthSlide",
    flag: "hasShownNineteenthSlide",
    done: "nineteenthSlideAnimationCompleted",
    line: "#nineteenthSlide .nineteenth-vertical-line",
  },
  {
    id: "twentiethSlide",
    flag: "hasShownTwentiethSlide",
    done: "twentiethSlideAnimationCompleted",
    line: "#twentiethSlide .twentieth-vertical-line",
  },
  {
    id: "twentiethSlide-new",
    flag: "hasShownTwentiethSlide-new",
    done: "twentiethSlide-newAnimationCompleted",
  },
  // { id: 'BYPASSModel', flag: 'hasShownDetailsBYPASSModel', done: 'BYPASSModelAnimationCompleted' },
  {
    id: "fourteenSlide-new4",
    flag: "hasShownFourteenSlide-new4",
    done: "fourteenSlide-new4AnimationCompleted",
    line: "#fourteenSlide-new4 .fourteen-vertical-line",
  },
  {
    id: "fourteenSlide-new5",
    flag: "hasShownFourteenSlide-new5",
    done: "fourteenSlide-new5AnimationCompleted",
    line: "#fourteenSlide-new5 .fourteen-vertical-line",
  },
  {
    id: "thankyou",
    flag: "hasShownThankyou",
    done: "thankyouAnimationCompleted",
  },
].map((s) => ({
  ...s,
...
function handleScroll(scrollY) {
  ...
  slides.forEach((s, index) => {
    ...
    const prevDone =
      index === 0 ? "textAnimationCompleted" : slides[index - 1].done;
...
function updateCurrentPage() {
  ...
  if (
    !userChangedInput &&
    parseInt(pageInput?.value) !== pageNumber &&
    pageNumber > 1
  ) {
...
function scrollToPage(page) {
  if (isNaN(page) || page < 1 || page > slides.length + 1 || userChangedInput)
    return;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const optionsscale = ["ATEX / IECEX Rated Electrical Components"];
...
const optionsSV = ["ATEX / IECEX Rated Electrical Components"];
...
const featuresyType = [
  "Simple Construction in Cast Iron or SS Materials ",
  "Flange or Pipe End Connection",
  "Pneumatic Actuator Operated ",
  "Sizes from 50 mm to 200 mm ",
  "DIN / ANSI / JIS Drilling Pattern",
  "Operating Temperature up to 80 deg c ",
];
...
const featuresLsv = [
  "Construction in SS 316L",
  "Pneumatic / Electric Actuator Operated ",
  "No External Moving Parts",
  "Easy to Maintain",
...
function animation(page) {
  ...
  const animatedPages = [7, 13, 19, 25,31, 35, 40, 44];
  const faqAnimation = [10, 16, 22, 28, 32, 37, 41, 46];
  if (page == "2" && previous != page) {
    ...
    tl.to(
      [".arrow-target1", ".arrow-target2", ".arrow-target3", ".arrow-target4"],
      {
        x: -35,
        opacity: 1,
        duration: 1.2,
...
window.addEventListener("resize", () => {
  ...
  if (widthDiff > 100 || heightDiff > 100) {
    // threshold to catch devtools or major resizes
    userChangedInput = true;
  }
...
const productConfig = {
  DTD: {
    ...
    animationSettings: {
      ...
      functions: { start: 0, end: 12.2, loop: true, autoplay: true },
  ...
  BDV: {
    ...
    viewerAttributes: {
      ...
      functions: {
        "min-field-of-view": "13.98deg",
        "max-field-of-view": "13.98deg",
        "min-camera-orbit": "auto 39deg auto",
        "max-camera-orbit": "auto 39deg auto",
        "camera-orbit": "-50deg 39deg 10.5m",
    ...
    animationSettings: {
      ...
      conversion: { start: 10, end: 150, loop: true, autoplay: true },
      diversion: { start: 190, end: 292, loop: true, autoplay: true },
      functions: { start: 2.55, end: 8.62, loop: true, autoplay: true },
      parts: { start: 0, end: 0, loop: false, autoplay: false },
    },
    visibleButtons: ["normal", "explode", "functions"],
  },
  SDTD: {
    ...
    viewerAttributes: {
      normal: {
        ...
        "min-camera-orbit": "auto 78deg auto",
        "max-camera-orbit": "auto 78deg auto",
        "camera-orbit": "-91.68deg 84.48deg 1.864m"
      },
      conversion: {
    ...
    animationSettings: {
      normal: { start: 0, end: 0, loop: false, autoplay: false },
      explode: { start: 0, end: 5.75, loop: false, autoplay: true },
      conversion: { start: 0, end: 8.73, loop: true, autoplay: true },
      diversion: { start: 8.73, end: 20, loop: true, autoplay: true },
      functions: { start: 0, end: 8.62, loop: true, autoplay: true },
      parts: { start: 0, end: 0, loop: false, autoplay: false },
    },
    visibleButtons: ["normal", "diversion"],
  },
  SDTD_C: {
    modelPaths: {
      normal: "SDTD/SDTD_Normal.glb",
...
buttons.conversion.addEventListener("click", () =>
  handleModelSwitch("conversion")
);
buttons.diversion.addEventListener("click", () => {
  handleModelSwitch("diversion");
  handleModelSwitch("diversion");
}
);
buttons.parts.addEventListener("click", () => handleModelSwitch("parts"));
buttons.functions.addEventListener("click", () =>
  handleModelSwitch("functions")
);
  ...
  if (modelPath) {
    ...
    if (actionKey === "normal") {
      ...
      playAnimationSegment({
        start: animationSettings.start,
        end: animationSettings.end,
        loop: false,
        autoplay: true,
      });
...
// questionnaire onclick function
function changeImage(src) {
  document.getElementById("questionnaire-display-image").src = src;
}